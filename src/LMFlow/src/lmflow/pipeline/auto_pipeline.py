...
from lmflow.pipeline.raft_aligner_t2t import RaftAlignerT2T
from lmflow.pipeline.mrt_aligner_t2t import MRTAlignerT2T
...
PIPELINE_MAPPING = {
    ...
    "raft_aligner_t2t": RaftAlignerT2T,
    "mrt_aligner_t2t": MRTAlignerT2T
}

...
model_save=$WS/models/raftplus-data.wiki-28k+llm.llama-2-7b-hf+rm.mqm
data_path=$WS/data/raft/wiki-28k
...
deepspeed --num_gpus 8 --master_port $MASTER_PORT \
    $train_path \
    --len_ratio "{\"en-uk\": \"1.32,1.85\", \"uk-en\": \"0.59,0.83\", \"uk-cs\": \"0.89,1.23\", \"cs-uk\": \"0.88,1.22\"}" \
    --lang_detect True \
    --repeat_detect True \

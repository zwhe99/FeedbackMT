...
model_path=$WS/models/sft-data.wiki-train+llm.nllb-200-1.3B
model_save=$WS/models/raftplus-data.wiki-28k+llm.nllb-200-1.3B+rm.mqm
data_path=$WS/data/raft/wiki-28k-t2t
...
deepspeed --num_gpus 8 --master_port $MASTER_PORT \
    $train_path \
    --len_ratio "{\"en-uk\": \"1.05,1.43\", \"uk-en\": \"0.70,0.95\", \"uk-cs\": \"0.84,1.17\", \"cs-uk\": \"0.86,1.19\"}" \
    --lang_detect True \
    --repeat_detect True \
